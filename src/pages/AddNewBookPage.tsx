  ...
  return (
    <div className="flex-1">
      <label className="block mb-10">
        ...
        <div className="h-100 border-2 border-dashed border-zinc-300 bg-zinc-50 rounded-lg justify-center flex flex-col items-center gap-4">
      ...
      <label className="block mb-6">
        ...
        <textarea
          className="h-30 w-full rounded-lg border border-gray-200 p-3 bg-zinc-50"
